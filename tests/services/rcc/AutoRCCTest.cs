...
namespace RCCService.Test
{
    ...
    public class AutoRCCTest
    {
        ...
        public void MyTestInitialize()
        {
            ...
            const string service_LOCAL = @"..\..\..\apps\services\rcc\source\bin\" + buildTarget + @"\RCCService.exe";
            ...
            const string dir_LOCAL = @"..\..\..\tests\services\rcc\TestRBXLFiles";
        ...
        public void TestRunRBXL()
        {
            ...
            string localdir = @"..\\..\\..\\tests\\services\\rcc\\TestRBXLFiles";
