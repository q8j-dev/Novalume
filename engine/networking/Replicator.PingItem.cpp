...
Replicator::PingItem::PingItem(Replicator* replicator, NetworkTime time, unsigned int extraStats)
		: PooledItem(*replicator), time(time), extraStats(extraStats)
	{}

bool Replicator::PingItem::write(RBX::Network::PacketBuffer& bitStream) {
...
shared_ptr<DeserializedItem> Replicator::PingItem::read(Replicator& replicator, RBX::Network::PacketBuffer& inBitstream)
{
