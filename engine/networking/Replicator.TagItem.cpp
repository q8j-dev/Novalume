...
bool Replicator::TagItem::write(RBX::Network::PacketBuffer& bitStream) 
{
...
shared_ptr<DeserializedItem> Replicator::TagItem::read(Replicator& replicator, RBX::Network::PacketBuffer& inBitstream)
{
