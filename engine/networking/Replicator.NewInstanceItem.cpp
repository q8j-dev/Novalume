...
bool Replicator::NewInstanceItem::write(RBX::Network::PacketBuffer& bitStream) 
{
...
bool Replicator::NewInstanceItem::read(Replicator& replicator, RBX::Network::PacketBuffer& bitStream, bool isJoinData, DeserializedNewInstanceItem& deserializedItem)
{
	if (isJoinData)
...
shared_ptr<DeserializedItem> Replicator::NewInstanceItem::read(Replicator& replicator, RBX::Network::PacketBuffer& bitStream, bool isJoinData)
{	
