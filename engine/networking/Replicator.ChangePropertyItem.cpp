...
bool Replicator::ChangePropertyItem::write(RBX::Network::PacketBuffer& bitStream) {
...
shared_ptr<DeserializedItem> Replicator::ChangePropertyItem::read(Replicator& replicator, RBX::Network::PacketBuffer& inBitstream)
{
