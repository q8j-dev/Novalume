...
bool Replicator::RockyItem::write(RBX::Network::PacketBuffer& bitStream) {
...
bool Replicator::NetPmcResponseItem::write(RBX::Network::PacketBuffer& bitStream)
{
	writeItemType(bitStream, ItemTypeRocky);
...
bool Replicator::RockyDbgItem::write(RBX::Network::PacketBuffer& bitStream)
{
	writeItemType(bitStream, ItemTypeRocky);
...
bool Replicator::NetPmcChallengeItem::write(RBX::Network::PacketBuffer& bitStream)
{
	writeItemType(bitStream, ItemTypeRocky);
...
shared_ptr<DeserializedItem> Replicator::RockyItem::read(Replicator& replicator, RBX::Network::PacketBuffer& bitStream)
{
