...
bool Replicator::DeleteInstanceItem::write(RBX::Network::PacketBuffer& bitStream) {
	if (!id.valid)
...
shared_ptr<DeserializedItem> Replicator::DeleteInstanceItem::read(Replicator& replicator, RBX::Network::PacketBuffer& inBitstream)
{
