...
bool ErrorCompPhysicsSender::sendPhysicsData(RBX::Network::PacketBuffer& bitStream, const Nugget& nugget)
{
...
void ErrorCompPhysicsSender::writeAssembly(RBX::Network::PacketBuffer& bitStream, const Assembly* assembly, Compressor::CompressionType compressionType, bool crossPacketCompression)
{
