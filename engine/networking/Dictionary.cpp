...
void SenderDictionary<const RBX::Name*>::send(RBX::Network::PacketBuffer& stream, const RBX::Name* value)
{
...
void SharedStringDictionary::serializeString(const std::string& stringValue, RBX::Network::PacketBuffer &bitStream)
{
	SenderDictionary<std::string>::send(bitStream, stringValue);
}

void SharedStringDictionary::serializeString(const ConstProperty& property, RBX::Network::PacketBuffer &bitStream)
{
...
void SharedStringDictionary::deserializeString(std::string& valueString, RBX::Network::PacketBuffer &bitStream)
{
	ReceiverDictionary<std::string>::receive(bitStream, valueString);
}

void SharedStringDictionary::deserializeString(Property& property, RBX::Network::PacketBuffer &bitStream)
{
	std::string value;
...
void SharedStringProtectedDictionary::serializeString(const std::string& stringValue, RBX::Network::PacketBuffer &bitStream)
{
	SenderDictionary<std::string>::send(bitStream, stringValue);
}

void SharedStringProtectedDictionary::serializeString(const ConstProperty& property, RBX::Network::PacketBuffer &bitStream)
{
	const PropertyDescriptor& desc = property.getDescriptor();
	std::string value = desc.getStringValue(property.getInstance());
...
bool SharedStringProtectedDictionary::deserializeString(std::string& valueString, RBX::Network::PacketBuffer &bitStream)
{
	return ReceiverStringDictionary::receive(bitStream, valueString);
}

bool SharedStringProtectedDictionary::deserializeString(Property& property, RBX::Network::PacketBuffer &bitStream)
{
	std::string value;
...
void SharedBinaryStringDictionary::serializeString(const BinaryString& stringValue, RBX::Network::PacketBuffer &bitStream)
{
	SenderDictionary<BinaryString>::send(bitStream, stringValue);
}

void SharedBinaryStringDictionary::serializeString(const ConstProperty& property, RBX::Network::PacketBuffer &bitStream)
{
...
void SharedBinaryStringDictionary::deserializeString(BinaryString& valueString, RBX::Network::PacketBuffer &bitStream)
{
	ReceiverDictionary<BinaryString>::receive(bitStream, valueString);
}

void SharedBinaryStringDictionary::deserializeString(Property& property, RBX::Network::PacketBuffer &bitStream)
{
	BinaryString value;
	deserializeString(value,bitStream);
