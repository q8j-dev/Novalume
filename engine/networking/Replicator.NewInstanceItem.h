...
public:
	...
	bool write(RBX::Network::PacketBuffer& bitStream);
	static bool read(Replicator& replicator, RBX::Network::PacketBuffer& bitStream, bool isJoinData, DeserializedNewInstanceItem& deserializedData);
	static shared_ptr<DeserializedItem> read(Replicator& replicator, RBX::Network::PacketBuffer& bitStream, bool isJoinData);
};
