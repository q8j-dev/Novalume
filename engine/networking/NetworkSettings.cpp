...
namespace RBX
{
	...
	template<> EnumDesc<Network::PacketReliability>::EnumDesc()
	:EnumDescriptor("PacketReliability")
	{
		addPair(Network::UNRELIABLE, "UNRELIABLE");
		addPair(Network::UNRELIABLE_SEQUENCED, "UNRELIABLE_SEQUENCED");
		addPair(Network::RELIABLE, "RELIABLE");
		addPair(Network::RELIABLE_ORDERED, "RELIABLE_ORDERED");
		addPair(Network::RELIABLE_SEQUENCED, "RELIABLE_SEQUENCED");
	}

	template<> EnumDesc<Network::PacketPriority>::EnumDesc()
		:EnumDescriptor("Network::PacketPriority")
	{
		addPair(Network::IMMEDIATE_PRIORITY, "IMMEDIATE_PRIORITY");
		addPair(Network::HIGH_PRIORITY, "HIGH_PRIORITY");
		addPair(Network::MEDIUM_PRIORITY, "MEDIUM_PRIORITY");
		addPair(Network::LOW_PRIORITY, "LOW_PRIORITY");
	}
	...
	static Reflection::EnumPropDescriptor<NetworkSettings, Network::PacketPriority> prop_PhysicsSendPriority("PhysicsSendPriority", "Physics", &NetworkSettings::getPhysicsSendPriority, &NetworkSettings::setPhysicsSendPriority, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING);
	...
	static Reflection::EnumPropDescriptor<NetworkSettings, Network::PacketPriority> prop_DataSendPriority("DataSendPriority", "Data", &NetworkSettings::getDataSendPriority, &NetworkSettings::setDataSendPriority, Reflection::PropertyDescriptor::HIDDEN_SCRIPTING);
	...
	NetworkSettings::NetworkSettings(void)
		...
		,physicsSendPriority(Network::HIGH_PRIORITY)
		,dataSendPriority(Network::MEDIUM_PRIORITY)
	...
	void NetworkSettings::setPhysicsSendPriority(const Network::PacketPriority& value)
	{
	...
	void NetworkSettings::setDataSendPriority(const Network::PacketPriority& value)
	{
