...
namespace RBX
{
	...
	namespace Network
	{
		...
		public:
			...
			bool trySend(RBX::Network::PacketBuffer& stream, const T& value)
			{
			...
			void send(RBX::Network::PacketBuffer& stream, const T& value)
			{
				if (isDefaultValue(value))
				{
					// id==0 is reserved for the empty item
			...
			void sendEmptyItem(RBX::Network::PacketBuffer& stream)
			{
				// id==0 is reserved for the empty item
				unsigned char id = 0;
				stream.Write(id);
		...
		public:
			...
			bool trySend(RBX::Network::PacketBuffer& stream, const RBX::Name* value)
			{
			...
			void send(RBX::Network::PacketBuffer& stream, const RBX::Name* value);
		...
		public:
			/*void skip(RBX::Network::PacketBuffer& stream)
			{
				unsigned char id;
				stream.Read(id);
...
#pragma optimize( "", off )
			...
			bool receive(RBX::Network::PacketBuffer& stream, T& value)
			{
				unsigned char id;
				stream.Read(id);
...
#pragma optimize( "", on ) 
		...
		{
		public:
			void serializeString(const std::string& value, RBX::Network::PacketBuffer &bitStream);
			void serializeString(const Reflection::ConstProperty& property, RBX::Network::PacketBuffer &bitStream);
			void send(RBX::Network::PacketBuffer& stream, const RBX::Name& value) {
				SenderDictionary<std::string>::send(stream, value.toString());
			}
			void send(RBX::Network::PacketBuffer& stream, const char* value) {
				SenderDictionary<std::string>::send(stream, std::string(value));
			}
			bool trySend(RBX::Network::PacketBuffer& stream, const RBX::Name& value) {
				return SenderDictionary<std::string>::trySend(stream, value.toString());
			}
			bool trySend(RBX::Network::PacketBuffer& stream, const char* value) {
				return SenderDictionary<std::string>::trySend(stream, std::string(value));
			}
			void deserializeString(std::string& value, RBX::Network::PacketBuffer &bitStream);
			void deserializeString(Reflection::Property& property, RBX::Network::PacketBuffer &bitStream);
			void receive(RBX::Network::PacketBuffer& stream, const RBX::Name*& value) {
				std::string s;
		...
		public:
			...
			bool deserializeString(std::string& value, RBX::Network::PacketBuffer &bitStream);
			bool deserializeString(Reflection::Property& property, RBX::Network::PacketBuffer &bitStream);
			void receive(RBX::Network::PacketBuffer& stream, const RBX::Name*& value) {
				std::string s;
		...
		{
		public:
			void serializeString(const BinaryString& value, RBX::Network::PacketBuffer &bitStream);
			void serializeString(const Reflection::ConstProperty& property, RBX::Network::PacketBuffer &bitStream);
            
			void deserializeString(BinaryString& value, RBX::Network::PacketBuffer &bitStream);
			void deserializeString(Reflection::Property& property, RBX::Network::PacketBuffer &bitStream);
		};
	}
}
