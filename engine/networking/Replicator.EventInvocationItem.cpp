...
bool Replicator::EventInvocationItem::write(RBX::Network::PacketBuffer& bitStream)
{
...
shared_ptr<DeserializedItem> Replicator::EventInvocationItem::read(Replicator& replicator, RBX::Network::PacketBuffer& inBitstream)
{
