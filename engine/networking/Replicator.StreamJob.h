...
public:
	...
	void readInstanceRemoval(RBX::Network::PacketBuffer& bitStream);
...
public:
	...
	/* override */ bool write(RBX::Network::PacketBuffer& bitStream);
	...
	static shared_ptr<DeserializedStreamDataItem> read(Replicator& replicator, RBX::Network::PacketBuffer& inBitstream);
};
