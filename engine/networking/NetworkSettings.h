...
namespace RBX
{
	...
	private:
		...
		Network::PacketPriority physicsSendPriority;
		Network::PacketPriority dataSendPriority;
    ...
    public:
		...
		Network::PacketPriority getPhysicsSendPriority() const { return physicsSendPriority; }
		void setPhysicsSendPriority(const Network::PacketPriority& value);

		Network::PacketPriority getDataSendPriority() const { return dataSendPriority; }
		void setDataSendPriority(const Network::PacketPriority& value);
