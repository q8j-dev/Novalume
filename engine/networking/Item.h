...
public:
	...
	virtual ~Item() {}
	virtual bool write(RBX::Network::PacketBuffer& bitStream) = 0;
	static void writeItemType(RBX::Network::PacketBuffer& stream, Item::ItemType value);
	static void readItemType(RBX::Network::PacketBuffer& stream, Item::ItemType& value);
};
