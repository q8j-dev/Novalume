...
protected:
	bool writeInstance(const Instance* instance, RBX::Network::PacketBuffer& bitStream);

	size_t writeInstances(RBX::Network::PacketBuffer& bitStream);

    void writeBonus(RBX::Network::PacketBuffer& bitStream, unsigned int bytes)
	{
