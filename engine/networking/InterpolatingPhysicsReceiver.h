...
namespace RBX { 
	...
	class InterpolatingPhysicsReceiver : public PhysicsReceiver
	{
		...
		public:
			...
			void receive(RBX::Network::PacketBuffer& bitsream, NetworkTime timeStamp, const ModelInstance* noLagModel, InterpolatingPhysicsReceiver* receiver);
			bool step(NetworkTime time, InterpolatingPhysicsReceiver* receiver) const;	// returns false if the item should be removed from the list
		};
		...
		typedef multi_index_container<
		  ...
		  indexed_by<
			...
			ordered_non_unique< 
				...
				BOOST_MULTI_INDEX_MEMBER(Nugget,NetworkTime,lastUpdate)
			>
		  >
		> Nuggets;
		Nuggets nuggets;
