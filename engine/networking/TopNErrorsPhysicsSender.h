...
namespace RBX { 
	...
	private:
		void updateErrors();
		bool sendPhysicsData(RBX::Network::PacketBuffer& bitStream, const Nugget& nugget, CoordinateFrame& outLastSendCFrame, float& accumulatedError, const PartInstance* playerHead);
