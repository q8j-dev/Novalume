...
void InterpolatingPhysicsReceiver::Nugget::receive(RBX::Network::PacketBuffer& bitstream, NetworkTime timeStamp, const ModelInstance* noLagModel, InterpolatingPhysicsReceiver* receiver)
{
	if (history->count>0)
	{
...
bool InterpolatingPhysicsReceiver::Nugget::step(NetworkTime time, InterpolatingPhysicsReceiver* receiver) const
{
	if (part->getDragging()) {
		return false;
	}
...
void InterpolatingPhysicsReceiver::step(NetworkTime time)
{
...
void InterpolatingPhysicsReceiver::receivePacket(RBX::Network::PacketBuffer& inBitstream, NetworkTime timeStamp, ReplicatorStats::PhysicsReceiverStats* stats)
{
