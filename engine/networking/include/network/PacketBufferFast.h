...
namespace RBX
{
	namespace Network
	{
		...
		{
			template <class T>
			static inline void readFast(PacketBuffer& bitStream, T& result, unsigned int bits)
			{
			...
			static inline void readFast(PacketBuffer& bitStream, T& result)
			{
		...
		template <class T>
		inline void readFastN(PacketBuffer& bitStream, T& result, unsigned int bits) {
		...
		template <unsigned int Bits, class T>
		inline void readFastN(PacketBuffer& bitStream, T& result) {
		...
		template <class T>
		inline void readFastT(PacketBuffer& bitStream, T& result)
		{
			BOOST_STATIC_ASSERT( sizeof(T) == 0 ); // This is undefined.
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, bool& result)
		{
			unsigned int readOffset = bitStream.GetReadOffset();
		...
		template <>
		inline void readFastT(PacketBuffer& bitStream, float& result) {
		...
		template <>
		inline void readFastT(PacketBuffer& bitStream, double& result) {
		...
		template <>
		inline void readFastT(PacketBuffer& bitStream, int8_t& result) {
			ReadFastBytes<1>::readFast<8, uint8_t>(bitStream, (uint8_t&)result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, uint8_t& result) {
			ReadFastBytes<1>::readFast<8, uint8_t>(bitStream, result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, char& result) {
			ReadFastBytes<1>::readFast<8, uint8_t>(bitStream, (uint8_t&)result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, int16_t& result) {
			ReadFastBytes<2>::readFast<16, uint16_t>(bitStream, (uint16_t&)result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, uint16_t& result) {
			ReadFastBytes<2>::readFast<16, uint16_t>(bitStream, result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, int32_t& result) {
			ReadFastBytes<4>::readFast<32, uint32_t>(bitStream, (uint32_t&)result);
		}
        
		template <>
		inline void readFastT(PacketBuffer& bitStream, long& result) {
#if defined(__LP64__)
		...
		template <>
		inline void readFastT(PacketBuffer& bitStream, unsigned long& result) {
#if defined(__LP64__)
		...
		template <>
		inline void readFastT(PacketBuffer& bitStream, uint32_t& result) {
			ReadFastBytes<4>::readFast<32, uint32_t>(bitStream, result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, int64_t& result) {
			ReadFastBytes<0>::readFast<64, uint64_t>(bitStream, (uint64_t&)result);
		}

		template <>
		inline void readFastT(PacketBuffer& bitStream, uint64_t& result) {
			ReadFastBytes<0>::readFast<64, uint64_t>(bitStream, result);
		}

		// --------------------------------------------------------------------

		inline void readVectorFast(PacketBuffer& bitStream, float& x, float& y, float& z)
		{
			float magnitude;
