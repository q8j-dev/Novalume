...
static Reflection::BoundFuncDesc<Animator, shared_ptr<const Reflection::ValueArray>()> desc_GetPlayingAnimationTracks(&Animator::getPlayingAnimationTracks, "GetPlayingAnimationTracks", Security::None);
static Reflection::BoundFuncDesc<Animator, shared_ptr<const Reflection::ValueArray>()> desc_GetPlayingAnimationTracksCoreScript(&Animator::getPlayingAnimationTracks, "GetPlayingAnimationTracksCoreScript", Security::RobloxScript);
static Reflection::EventDesc<Animator, void(shared_ptr<Instance>)> event_AnimationPlayed(&Animator::animationPlayedSignal, "AnimationPlayed", "animationTrack", Security::None);
static Reflection::EventDesc<Animator, void(shared_ptr<Instance>)> event_AnimationPlayedCoreScript(&Animator::animationPlayedCoreScriptSignal, "AnimationPlayedCoreScript", "animationTrack", Security::RobloxScript);
static Reflection::EventDesc<Animator, void(shared_ptr<Instance>)> event_AnimationStreamTrackPlayed(
    &Animator::animationStreamTrackPlayedSignal, "AnimationStreamTrackPlayed",
    "animationTrack", Security::RobloxScript);
...
void Animator::appendAnimatableJointsRec(shared_ptr<Instance> instance, shared_ptr<Instance> exclude)
{
	...
	IAnimatableJoint* joint = dynamic_cast<IAnimatableJoint*>(instance.get());
	if(joint)
	{
...
void Animator::tellParentAnimationPlayed(shared_ptr<Instance> animationTrack) {
	...
	animationPlayedSignal(animationTrack);
	animationPlayedCoreScriptSignal(animationTrack);
