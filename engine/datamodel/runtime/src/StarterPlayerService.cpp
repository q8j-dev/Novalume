...
REFLECTION_END();
	...
	namespace Reflection {
		...
		{	
			...
			addPair(StarterPlayerService::DEV_TOUCH_CAMERA_MOVEMENT_MODE_ORBITAL, "Orbital");
		}
		...
		{	
			...
			addPair(StarterPlayerService::DEV_COMPUTER_CAMERA_MOVEMENT_MODE_ORBITAL, "Orbital");
			addPair(StarterPlayerService::DEV_COMPUTER_CAMERA_MOVEMENT_MODE_CAMERA_TOGGLE, "CameraToggle");
		}
		...
		{	
			...
			addPair(StarterPlayerService::DEV_TOUCH_MOVEMENT_MODE_DYNAMIC_THUMBSTICK, "DynamicThumbstick");
		}
