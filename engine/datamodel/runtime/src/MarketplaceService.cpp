...
namespace RBX
{
	...
	static Reflection::EventDesc<MarketplaceService,
		void(shared_ptr<Instance>, long long, bool, MarketplaceService::CurrencyType,
			std::string, std::string)> event_promptPurchaseRequestedV2(
			&MarketplaceService::promptPurchaseRequestedV2, "PromptPurchaseRequestedV2",
			"player", "assetId", "equipIfPurchased", "currencyType",
			"idempotencyKey", "purchaseAuthToken", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void(long long, bool)> event_promptRobloxPurchaseRequested(
		&MarketplaceService::promptRobloxPurchaseRequested, "PromptRobloxPurchaseRequested", "assetId", "equipIfPurchased", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void(shared_ptr<Instance>, long long)> event_promptGamePassPurchaseRequested(
		&MarketplaceService::promptGamePassPurchaseRequested, "PromptGamePassPurchaseRequested", "player", "gamePassId", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void(shared_ptr<Instance>, long long)> event_promptBundlePurchaseRequested(
		&MarketplaceService::promptBundlePurchaseRequested, "PromptBundlePurchaseRequested", "player", "bundleId", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void(shared_ptr<Instance>, long long, bool)>
		event_promptBundlePurchaseFinished(
			&MarketplaceService::promptBundlePurchaseFinished,
			"PromptBundlePurchaseFinished", "player", "bundleId",
			"wasPurchased", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void(shared_ptr<Instance>)> event_promptPremiumPurchaseRequested(
		&MarketplaceService::promptPremiumPurchaseRequested, "PromptPremiumPurchaseRequested", "player", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void(std::string)> event_promptSubscriptionPurchaseRequested(
		&MarketplaceService::promptSubscriptionPurchaseRequested, "PromptSubscriptionPurchaseRequested", "subscriptionId", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService, void()> event_promptRobloxSubscriptionPurchaseRequested(
	...
	static Reflection::EventDesc<MarketplaceService,
		...
		event_promptBulkPurchaseRequestedV2(
			&MarketplaceService::promptBulkPurchaseRequestedV2,
			"PromptBulkPurchaseRequestedV2", "player", "displayData",
			"orderRequest", "purchaserRobuxBalance", "orderTotalRobux",
			"options", "discountInformation", Security::RobloxScript);
	static Reflection::EventDesc<MarketplaceService,
		void(shared_ptr<Instance>, Enums::MarketplaceBulkPurchasePromptStatus,
			shared_ptr<const Reflection::ValueTable>)>
		event_promptBulkPurchaseFinished(
			&MarketplaceService::promptBulkPurchaseFinished,
			"PromptBulkPurchaseFinished", "player", "status", "result",
		...
		:EnumDescriptor("InfoType")
	{
		...
		addPair(MarketplaceService::INFO_GAME_PASS, "GamePass");
		addPair(MarketplaceService::INFO_SUBSCRIPTION, "Subscription");
		addPair(MarketplaceService::INFO_BUNDLE, "Bundle");
	}
