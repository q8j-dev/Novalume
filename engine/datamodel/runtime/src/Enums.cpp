...
:EnumDescriptor("ScaleType")
{
	...
	addPair(RBX::GuiObject::SCALE_TILE, "Tile");
	addPair(RBX::GuiObject::SCALE_FIT, "Fit");
	addPair(RBX::GuiObject::SCALE_CROP, "Crop");
}
...
{
	addPair(RBX::AUTOMATIC_SIZE_NONE, "None");
	addPair(RBX::AUTOMATIC_SIZE_X, "X");
	addPair(RBX::AUTOMATIC_SIZE_Y, "Y");
	addPair(RBX::AUTOMATIC_SIZE_XY, "XY");
}

template<>
EnumDesc<RBX::GuiState>::EnumDesc()
:EnumDescriptor("GuiState")
{
	addPair(RBX::GUI_STATE_IDLE, "Idle");
	addPair(RBX::GUI_STATE_HOVER, "Hover");
	addPair(RBX::GUI_STATE_PRESS, "Press");
	addPair(RBX::GUI_STATE_NON_INTERACTABLE, "NonInteractable");
}
}//namespace Reflection
}//namespace RBX
