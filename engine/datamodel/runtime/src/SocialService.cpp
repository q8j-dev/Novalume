...
static Reflection::EventDesc<SocialService, void(shared_ptr<Instance>, shared_ptr<Instance>)> event_PromptInviteRequested(
	&SocialService::promptInviteRequestedSignal, "PromptInviteRequested", "player", "experienceInviteOptions", Security::RobloxScript);
static Reflection::EventDesc<SocialService, void(std::string)> event_ShowPromptRsvpToEvent(
	&SocialService::showPromptRsvpToEventSignal, "ShowPromptRsvpToEvent", "eventId", Security::RobloxScript);
static Reflection::EventDesc<SocialService, void(std::string)> event_OpenShareSheetWithLink(
	&SocialService::openShareSheetWithLinkSignal, "OpenShareSheetWithLink", "link", Security::RobloxScript);
REFLECTION_END();
