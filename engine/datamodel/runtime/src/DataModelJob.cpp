...
DataModelArbiter::DataModelArbiter(void)
{
...

	{
		...
		// NetworkPeer can be concurrent with everything except for Write,Physics,NetworkPeer:
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::PhysicsOut);	
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::DataOut);	
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::PhysicsIn);	
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::DataIn);	
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::Read);	
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::Render);	
		setConcurrent(lookup[Safe], DataModelJob::NetworkPeer, DataModelJob::None);
		...
		setConcurrent(lookup[Safe], DataModelJob::None, DataModelJob::NetworkPeer);	
	}
