...
const Reflection::PropDescriptor<Decal, G3D::Color3> Decal::prop_Color3(
	"Color3", category_Appearance, &Decal::getColor3, &Decal::setColor3);
...
void Decal::setColor3(const G3D::Color3& value)
{
	if (value != color)
	{
		color = value;
		raisePropertyChanged(prop_Color3);
	}
}
...
const Reflection::PropDescriptor<DecalTexture, float> DecalTexture::prop_OffsetStudsU("OffsetStudsU", category_Appearance, &DecalTexture::getOffsetStudsU, &DecalTexture::setOffsetStudsU);
const Reflection::PropDescriptor<DecalTexture, float> DecalTexture::prop_OffsetStudsV("OffsetStudsV", category_Appearance, &DecalTexture::getOffsetStudsV, &DecalTexture::setOffsetStudsV);

DecalTexture::DecalTexture(void)
	:studsPerTile(2.0f,2.0f)
	,offsetStuds(0.0f,0.0f)
{
	setName("Texture");
}
...
void DecalTexture::setOffsetStudsU(float value)
{
	if (offsetStuds.x != value)
	{
		offsetStuds.x = value;
		raisePropertyChanged(prop_OffsetStudsU);
	}
}

void DecalTexture::setOffsetStudsV(float value)
{
	if (offsetStuds.y != value)
	{
		offsetStuds.y = value;
