...
namespace RBX {
	...
	static Reflection::RemoteEventDesc<BadgeService, void(long long, long long, long long)> event_OnBadgeAwarded(
		&BadgeService::onBadgeAwardedSignal, "OnBadgeAwarded", "userId", "creatorId", "badgeId",
