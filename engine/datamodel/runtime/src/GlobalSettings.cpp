...
// Defaults recovered from the supplied 2026 Android client registration
// records. They are dynamic because the production client-settings response
// can override them before CorePackages start.
DYNAMIC_FASTINTVARIABLE(LuaAppNonFinalThumbnailMaxRetries, 2)
DYNAMIC_FASTINTVARIABLE(LuaAppThumbnailsApiRetryTimeMultiplier, 120)
DYNAMIC_FASTINTVARIABLE(PercentReportingNetworkProfileAfterStartup, 0)
DYNAMIC_FASTINTVARIABLE(PercentReportingByCountryCode, 0)
DYNAMIC_FASTFLAGVARIABLE(LocalizeErrorCodeString, false)
DYNAMIC_FASTFLAGVARIABLE(CollectAnalyticsForSystemMenu, true)
DYNAMIC_FASTINTVARIABLE(InGameGlobalGuiInset, 36)
DYNAMIC_FASTSTRINGVARIABLE(LuaShareGameSettingsHubInviteCounter, "ShareGameSettingsHubInviteSent")
DYNAMIC_FASTSTRINGVARIABLE(LuaShareGameModalPromptInviteCounter, "ShareGameModalPromptInviteSent")
DYNAMIC_FASTSTRINGVARIABLE(LuaShareGameSettingsHubEntryCounter, "ShareGameSettingsHubEntryPoint")
DYNAMIC_FASTSTRINGVARIABLE(LuaShareGameModalPromptEntryCounter, "ShareGameModalPromptEntryPoint")
