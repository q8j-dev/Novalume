...
namespace RBX
{
	...
	static Reflection::EventDesc<GroupService, void(long long)> event_ShowJoinPrompt(
		&GroupService::showJoinPromptSignal, "ShowJoinPrompt", "groupId", Security::RobloxScript);
    REFLECTION_END();
