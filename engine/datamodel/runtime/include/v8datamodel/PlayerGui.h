...
namespace RBX {
	...
	private:
		...
		Enums::ScreenOrientation screenOrientation;
		Enums::ScreenOrientation currentScreenOrientation;
	public:
        PlayerGui();
		...
		Enums::ScreenOrientation getScreenOrientation() const { return screenOrientation; }
		void setScreenOrientation(Enums::ScreenOrientation value);
		Enums::ScreenOrientation getCurrentScreenOrientation() const { return currentScreenOrientation; }
		void setCurrentScreenOrientation(Enums::ScreenOrientation value);
	...
	public:
		enum CoreGuiType
		{
			...
			COREGUI_CHATGUI			= 3,
			COREGUI_ALL				= 4,
			COREGUI_EMOTESMENU		= 5,
			COREGUI_SELFVIEW			= 6,
			COREGUI_CAPTURES			= 7,
			COREGUI_AVATARSWITCHER	= 8,
			COREGUI_EXPERIENCESHOP	= 9
		};
	...
	public:
		...
		rbx::signal<void(bool, shared_ptr<Instance>, NormalId, float)> userGuiRenderingChangedSignal;
		void setUserGuiRendering(bool enabled, const shared_ptr<Instance>& guiAdornee,
