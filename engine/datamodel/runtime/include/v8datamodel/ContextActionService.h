...
namespace RBX {
    ...
    struct BoundFunctionData
    {
        ...
        BoundFunctionData(shared_ptr<const Reflection::Tuple> newInputTypes, boost::function<Enums::ContextActionResult(shared_ptr<Reflection::Tuple>)> newFunction, bool touchButton)
        : inputTypes(newInputTypes)
        , image("")
        , title("")
        , description("")
        ...
        BoundFunctionData(boost::function<Enums::ContextActionResult(shared_ptr<Reflection::Tuple>)> newFunction, bool touchButton)
        : inputTypes()
        , image("")
        , title("")
        , description("")
	...
	public:
		...
		void bindCoreActionAtPriority(const std::string actionName, Lua::WeakFunctionRef functionToBind, bool createTouchButton, int priorityLevel, shared_ptr<const Reflection::Tuple> hotkeys);
		...
		void bindActionAtPriority(const std::string actionName, Lua::WeakFunctionRef functionToBind, bool createTouchButton, int priorityLevel, shared_ptr<const Reflection::Tuple> hotkeys);
		...
		Enums::ContextActionResult callFunction(boost::function<Enums::ContextActionResult(shared_ptr<Reflection::Tuple>)> luaFunction, const std::string actionName, const InputObject::UserInputState state, const shared_ptr<Instance> inputObject);
	...
	private:
		...
		void bindActionInternal(const std::string actionName, Lua::WeakFunctionRef functionToBind, bool createTouchButton, shared_ptr<const Reflection::Tuple> hotkeys, FunctionMap& funcMap, FunctionVector& funcVector, int priorityLevel = PRIORITY_MEDIUM);
...
template<> EnumDesc<RBX::ContextActionService::Priority>::EnumDesc();
} }
