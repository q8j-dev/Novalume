...
namespace RBX
{
    ...
    public:
        ...
        rbx::signal<void(float, RBX::Vector2, float, bool)> pointerActionSignal;
		...
		ContentId getImageForKeyCode(KeyCode keyCode);
		std::string getStringForKeyCode(KeyCode keyCode);
        ...
        Vector2 getStatusBarSize() const { return statusBarSize; }
        Vector2 getNavBarSize() const { return navBarSize; }
        Vector2 getBottomBarSize() const { return bottomBarSize; }
        ...
        RBX::Vector2 getMouseDelta() { return currentMouseDelta; }
        ...
        Enums::PreferredInput getPreferredInput() const { return preferredInput; }
