...
namespace RBX
{
	...
	public:
        ...
        void setScrollingDirection(Enums::ScrollingDirection value);
        Enums::ScrollingDirection getScrollingDirection() const { return allowedScrollingDirection; }
        Enums::ScrollBarInset getHorizontalScrollBarInset() const { return horizontalScrollBarInset; }
        void setHorizontalScrollBarInset(Enums::ScrollBarInset value);
        Enums::ScrollBarInset getVerticalScrollBarInset() const { return verticalScrollBarInset; }
        void setVerticalScrollBarInset(Enums::ScrollBarInset value);
        Enums::VerticalScrollBarPosition getVerticalScrollBarPosition() const { return verticalScrollBarPosition; }
        void setVerticalScrollBarPosition(Enums::VerticalScrollBarPosition value);
        
		UDim2 getCanvasSize() const { return canvasSize; }
		void setCanvasSize(UDim2 value);
		AutomaticSize getAutomaticCanvasSize() const { return automaticCanvasSize; }
		void setAutomaticCanvasSize(AutomaticSize value);
		Vector2 getAbsoluteCanvasSize() const;
		...
		Color3 getScrollBarImageColor3() const { return scrollBarImageColor; }
		void setScrollBarImageColor3(Color3 value);
		float getScrollBarImageTransparency() const { return scrollBarImageTransparency; }
		void setScrollBarImageTransparency(float value);
    ...
    private:
		...
		Color3 scrollBarImageColor;
		float scrollBarImageTransparency;

		UDim2 canvasSize;
		AutomaticSize automaticCanvasSize;
        ...
        Enums::ScrollingDirection allowedScrollingDirection;
        Enums::ScrollBarInset horizontalScrollBarInset;
        Enums::ScrollBarInset verticalScrollBarInset;
        Enums::VerticalScrollBarPosition verticalScrollBarPosition;
