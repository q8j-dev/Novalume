...
namespace RBX {
	...
	public:
		...
		const Vector3& getStudsOffsetWorldSpace() const;
		void setStudsOffsetWorldSpace(const Vector3& value);
		...
		float getLightInfluence() const { return lightInfluence; }
		void setLightInfluence(float value);
	...
	private:
        ...
        Vector3 partStudsOffsetWorldSpace;
