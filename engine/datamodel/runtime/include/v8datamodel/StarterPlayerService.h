...
namespace RBX {
	...
	public:
		enum DeveloperTouchCameraMovementMode {
			...
			DEV_TOUCH_CAMERA_MOVEMENT_MODE_ORBITAL = 3 };
		enum DeveloperComputerCameraMovementMode {
			...
			DEV_COMPUTER_CAMERA_MOVEMENT_MODE_ORBITAL = 3,
			DEV_COMPUTER_CAMERA_MOVEMENT_MODE_CAMERA_TOGGLE = 4};
		...
		enum DeveloperTouchMovementMode { 
			...
			DEV_TOUCH_MOVEMENT_MODE_DYNAMIC_THUMBSTICK = 6	};
