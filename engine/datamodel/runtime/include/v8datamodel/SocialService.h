...
namespace RBX {
	...
	public:
		...
		rbx::signal<void(shared_ptr<Instance>, shared_ptr<Instance>)> promptInviteRequestedSignal;
		rbx::signal<void(std::string)> showPromptRsvpToEventSignal;
		rbx::signal<void(std::string)> openShareSheetWithLinkSignal;
