...
namespace RBX
{
    ...
    private:
		...
		static Reflection::BoundProp<bool> prop_gamepadCursorEnabled;
    ...
    public:
		...
		bool getGamepadCursorEnabled() const { return gamepadCursorEnabled; }
		void setGamepadCursorEnabled(bool enabled);
		void enableGamepadCursor(shared_ptr<Instance> guiObject);
		void disableGamepadCursor();
		Vector2 getGamepadCursorPosition() { return gamepadCursorPosition; }
		void setGamepadCursorPosition(Vector2 position);
		void autoSelectGuiLua() { autoSelectGui(); }
		rbx::signal<void(Vector2)> gamepadThumbstick1ChangedSignal;
