...
namespace RBX {
	...
	public:
		...
		// 
		// IAdornable
		/*override*/ bool shouldRender2d() const { return renderable && getEnabled(); }
		/*override*/ int render2dOrder() const { return displayOrder; }
		...
		ScreenInsetsType getScreenInsets() const { return screenInsets; }
		void setScreenInsets(ScreenInsetsType value);
		SafeAreaCompatMode getSafeAreaCompatibility() const { return safeAreaCompatibility; }
		void setSafeAreaCompatibility(SafeAreaCompatMode value);
		bool getClipToDeviceSafeArea() const { return clipToDeviceSafeArea; }
		void setClipToDeviceSafeArea(bool value);
		int getDisplayOrder() const { return displayOrder; }
		void setDisplayOrder(int value);
		bool getIgnoreGuiInset() const { return screenInsets == SCREEN_INSETS_NONE; }
		void setIgnoreGuiInset(bool value);
		bool getOnTopOfCoreBlur() const { return onTopOfCoreBlur; }
		void setOnTopOfCoreBlur(bool value);
	...
	private:
		...
		ScreenInsetsType screenInsets;
		SafeAreaCompatMode safeAreaCompatibility;
