...
namespace RBX
{
	...
	private:
		...
		Enums::ReturnKeyType returnKeyType;
	...
	public:
		...
		bool getOverlayNativeInput() const { return overlayNativeInput; }
		void setOverlayNativeInput(bool value);

		Enums::ReturnKeyType getReturnKeyType() const { return returnKeyType; }
		void setReturnKeyType(Enums::ReturnKeyType value);
		...
		rbx::signal<void()> returnPressedFromOnScreenKeyboardSignal;
