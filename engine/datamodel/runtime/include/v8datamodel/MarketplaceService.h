...
namespace RBX {
	...
	public:
		...
		rbx::signal<void(shared_ptr<Instance> player, long long assetId,
			bool equipIfPurchased, CurrencyType currencyType,
			std::string idempotencyKey, std::string purchaseAuthToken)>
			promptPurchaseRequestedV2;
		rbx::signal<void(long long, bool)> promptRobloxPurchaseRequested;
		rbx::signal<void(shared_ptr<Instance>, long long)> promptGamePassPurchaseRequested;
		rbx::signal<void(shared_ptr<Instance>, long long)> promptBundlePurchaseRequested;
		rbx::signal<void(shared_ptr<Instance>, long long, bool)>
			promptBundlePurchaseFinished;
		rbx::signal<void(shared_ptr<Instance>)> promptPremiumPurchaseRequested;
		rbx::signal<void(std::string)> promptSubscriptionPurchaseRequested;
		rbx::signal<void()> promptRobloxSubscriptionPurchaseRequested;
