...
namespace RBX {
	...
	namespace Soundscape
	{
		...
		public:
			...
			float getPlaybackSpeed() const { return getPitch(); }
			void setPlaybackSpeed(float value) { setPitch(value); }
			...
			bool getAcousticSimulationEnabled() const { return acousticSimulationEnabled; }
			void setAcousticSimulationEnabled(bool value);
			bool getPlaybackRegionsEnabled() const { return playbackRegionsEnabled; }
			void setPlaybackRegionsEnabled(bool value);
			NumberRange getLoopRegion() const { return loopRegion; }
			void setLoopRegion(NumberRange value);
			NumberRange getPlaybackRegion() const { return playbackRegion; }
			void setPlaybackRegion(NumberRange value);
			void setPlaying(bool value) { value ? play() : stop(); }
			...
			bool isSpatial() const { return is3D; }
