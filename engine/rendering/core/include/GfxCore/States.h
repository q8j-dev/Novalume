...
public:
    ...
    {
        size_t seed = 0;
        hashCombine(seed, cullMode);
        hashCombine(seed, depthBias);
        return seed;
    }
...
public:
    ...
    {
        size_t seed = 0;
        hashCombine(seed, colorSrc);
        hashCombine(seed, colorDst);
		hashCombine(seed, alphaSrc);
		hashCombine(seed, alphaDst);
		hashCombine(seed, colorMask);
        return seed;
    }

private:

    void construct(Factor colorSrcIn, Factor colorDstIn, Factor alphaSrcIn, Factor alphaDstIn, unsigned int colorMaskIn)
    {
...
public:
    ...
    {
        size_t seed = 0;
        hashCombine(seed, function);
        hashCombine(seed, write);
        hashCombine(seed, stencilMode);
        return seed;
    }
...
public:
    ...
    {
        size_t seed = 0;
        hashCombine(seed, filter);
        hashCombine(seed, address);
        hashCombine(seed, anisotropy);
        return seed;
    }
