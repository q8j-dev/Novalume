...
{
    boost::shared_ptr<Instance> effectCopy = effect;
    ...
    else
    {
        ...
        boost::shared_ptr<RBX::PartInstance> part = shared_from(parent);
            
        bind(part, effectCopy);
    }
}

void ExplosionEmitter::bind(const boost::shared_ptr<RBX::PartInstance>& part, const boost::shared_ptr<RBX::Instance>& instance)
{
