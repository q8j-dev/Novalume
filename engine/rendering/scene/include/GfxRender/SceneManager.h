...
public:
    ...
    void renderViewport(DeviceContext* context, Framebuffer* framebuffer, const RenderCamera& camera,
        unsigned int viewWidth, unsigned int viewHeight, const void* renderWorld,
        const Color4& background, const Color3& ambient, const Color3& lightColor,
    ...
    const Vector4& getShadowCascadeInfo() const { return globalShaderData.ShadowCascadeInfo; }
...
private: 
	...
	void renderShadowMap(DeviceContext* context, ShadowMap* shadowMap, const RenderCamera& camera, int qualityLevel);
