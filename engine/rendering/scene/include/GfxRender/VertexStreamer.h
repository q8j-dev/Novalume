...
namespace Graphics
{
	...
	public:
		...
		void triangleList2d(const Color4* colors, const Vector2* v, int vcount, const short* i, int icount);
		void texturedTriangleList2d(const shared_ptr<Texture>& texture, const Color4* colors, const Vector2* v,
			const Vector2* uv, int vcount, const short* i, int icount, BatchTextureType batchTexType, bool ignoreTexture);
		void triangleList(const Color4& color4, const CoordinateFrame& cframe, const Vector3* v, int vcount, const short* i, int icount);
		void triangleList(const Color4* colors, const CoordinateFrame& cframe, const Vector3* v, int vcount, const short* i, int icount);
		void texturedTriangleList(const shared_ptr<Texture>& texture, const Color4* colors, const CoordinateFrame& cframe,
			const Vector3* v, const Vector2* uv, int vcount, const short* i, int icount, BatchTextureType batchTexType);
