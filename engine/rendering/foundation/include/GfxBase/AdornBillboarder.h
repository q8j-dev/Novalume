...
namespace RBX {
	...
	public:
		...
		/*override*/ void convexPolygon2d(
			...
			int countv,
			const Color4&		color);
		/*override*/ void convexPolygon2d(const Vector2* v, const Color4* colors, int countv);
		/*override*/ void texturedPolygon2d(const Vector2* v, const Vector2* uv, const Color4* colors, int countv);

		/*override*/ void convexPolygon(
			const Vector3* v,
			int countv,
			const Color4&		color) { throw std::runtime_error("Invalid operation"); };
		/*override*/ void convexPolygon(const Vector3*, const Color4*, int) { throw std::runtime_error("Invalid operation"); };
		/*override*/ void texturedPolygon(const Vector3*, const Vector2*, const Color4*, int) { throw std::runtime_error("Invalid operation"); };
