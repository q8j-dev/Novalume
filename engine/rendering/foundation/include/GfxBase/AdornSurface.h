...
namespace RBX {
	...
	public:
		...
		void convexPolygon(const Vector3*, const Color4*, int)                                              { ; }
		void convexPolygon2d(const Vector2*, const Color4*, int)                                            { ; }
		void texturedPolygon(const Vector3*, const Vector2*, const Color4*, int)                             { ; }
		void texturedPolygon2d(const Vector2*, const Vector2*, const Color4*, int)                           { ; }
