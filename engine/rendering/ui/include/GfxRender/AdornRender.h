...
class AdornRender : public Adorn, public ViewportTextureProvider, public MediaTextureProvider
{
public:
    ...
    /*override*/ TextureProxyBaseRef requestViewportTexture(const ViewportTextureRequest& request);
    /*override*/ bool requiresViewportTextureFlipping() const;
    /*override*/ TextureProxyBaseRef requestMediaTexture(const void* owner,
    ...
    virtual void convexPolygon2d(const Vector2* v, const Color4* colors, int countv);
    virtual void texturedPolygon2d(const Vector2* v, const Vector2* uv, const Color4* colors, int countv);

    virtual void convexPolygon(const Vector3* v, int countv, const Color4& color);
    virtual void convexPolygon(const Vector3* v, const Color4* colors, int countv);
    virtual void texturedPolygon(const Vector3* v, const Vector2* uv, const Color4* colors, int countv);
...
private:
    ...
    std::map<const void*, MediaTexture> mediaTextures;
