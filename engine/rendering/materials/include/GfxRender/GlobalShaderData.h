...
struct GlobalShaderData
{
	...
	Vector4 ShadowMatrix3;
	Vector4 ShadowMatrix4;
	Vector4 ShadowMatrix5;
	Vector4 ShadowMatrix6;
	Vector4 ShadowMatrix7;
	Vector4 ShadowMatrix8;
	Vector4 ShadowCascadeInfo;
