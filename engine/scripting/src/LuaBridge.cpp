...
namespace RBX
{
	namespace Lua
	{
        ...
        template void Bridge <ScriptRandom>::registerClass(lua_State *);
        template void Bridge <TweenInfo>::registerClass(lua_State *);
        template void Bridge <RaycastParams>::registerClass(lua_State *);
        template void Bridge <OverlapParams>::registerClass(lua_State *);
        template void Bridge <RaycastResult>::registerClass(lua_State *);
		...
		template void Bridge <RBX::Path2DControlPoint>::registerClass(lua_State *);
		template void Bridge <RBX::DateTime>::registerClass(lua_State *);
		template void Bridge <RBX::Content>::registerClass(lua_State *);
		template void Bridge <RBX::Font>::registerClass(lua_State *);
	}
}
