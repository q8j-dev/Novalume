...
#if (defined(_M_X64) || defined(_M_IX86) || defined(__x86_64__) || defined(__i386__)) && !defined(RBX_STUDIO_BUILD)
...
namespace LuaVM
{
    ...
    // Loads raw Luau bytecode or an authenticated Player bytecode container.
    int loadBytecode(lua_State* L, std::span<const std::uint8_t> bytecode,
