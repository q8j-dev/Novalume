...
namespace RBX { namespace Lua {
	...
	class ValueObjectBridge : public SharedPtrBridge<Reflection::DescribedBase>
	{
		friend class SharedPtrBridge<Reflection::DescribedBase>;
	public:
	...
	void Bridge< shared_ptr<Reflection::DescribedBase>, false >::on_newindex(
		shared_ptr<Reflection::DescribedBase>& object, const char* name, lua_State* L);
