...
namespace RBX {
	...
	class Weld;
	class Animator;
	template<class ValueType, const char* const& sClassName> class NumericValue;
	...
	public:
		...
		enum BodyPartR15
		{
			BODY_PART_R15_HEAD = 0,
			BODY_PART_R15_UPPER_TORSO = 1,
			BODY_PART_R15_LOWER_TORSO = 2,
			BODY_PART_R15_LEFT_FOOT = 3,
			BODY_PART_R15_LEFT_LOWER_LEG = 4,
			BODY_PART_R15_LEFT_UPPER_LEG = 5,
			BODY_PART_R15_RIGHT_FOOT = 6,
			BODY_PART_R15_RIGHT_LOWER_LEG = 7,
			BODY_PART_R15_RIGHT_UPPER_LEG = 8,
			BODY_PART_R15_LEFT_HAND = 9,
			BODY_PART_R15_LEFT_LOWER_ARM = 10,
			BODY_PART_R15_LEFT_UPPER_ARM = 11,
			BODY_PART_R15_RIGHT_HAND = 12,
			BODY_PART_R15_RIGHT_LOWER_ARM = 13,
			BODY_PART_R15_RIGHT_UPPER_ARM = 14,
			BODY_PART_R15_ROOT_PART = 15,
			BODY_PART_R15_UNKNOWN = 17,
		};
	private:
		...
		void connectAvatarScaleValue(DoubleValue* value);
		void refreshAvatarScale();
		rbx::signals::scoped_connection bodyHeightScaleChanged;
		rbx::signals::scoped_connection bodyWidthScaleChanged;
		rbx::signals::scoped_connection bodyDepthScaleChanged;
		rbx::signals::scoped_connection headScaleChanged;
		rbx::signals::scoped_connection bodyTypeScaleChanged;
		rbx::signals::scoped_connection bodyProportionScaleChanged;
	...
	public:
		...
		bool getAutomaticScalingEnabled() const { return automaticScalingEnabled; }
		void setAutomaticScalingEnabled(bool value);
		...
		BodyPartR15 getBodyPartR15(shared_ptr<Instance> part);
		bool replaceBodyPartR15(BodyPartR15 bodyPart, shared_ptr<Instance> part);
		Vector3 getAccessoryHandleScale(shared_ptr<Instance> instance,
		...
		PartInstance* getRootPartDangerous() const;	// reflection only
		...
		void playEmoteAsync(std::string emoteName,
		...
		rbx::signal<void(bool, shared_ptr<Instance>)> emoteTriggeredSignal;
